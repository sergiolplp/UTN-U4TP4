...
if (valor1>=valor2 && valor1>=valor3){document.write('el número mayor es '+valor1);}
else if (valor2>=valor1 && valor2>=valor3){document.write('el número mayor es '+valor2);}
else document.write('el número mayor es '+valor3);